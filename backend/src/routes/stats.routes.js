...
// GET /api/reports/kpis - Get KPIs (super_admin only)
...
// GET /api/reports/trends - Get trends (super_admin only)
...
// GET /api/stats/overview - Get system overview (super_admin only)
